  ...
  const deleteProduct = async (productId) => {
    ...
    try {
      ...
      const { data } = await axios.delete(`/api/product/delete`, {
        ...
        data: { productId }   // axios DELETE body
      });
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="flex items-center gap-1 px-1.5 md:px-3.5 py-2 bg-orange-600 text-white rounded-md max-sm:hidden"
                          >
                          ...
                          <button
                            ...
                            className="flex items-center gap-1 px-1.5 md:px-3.5 py-2 bg-red-500 hover:bg-red-600 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-md transition-colors"
                          >
